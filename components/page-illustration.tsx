      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="none" width="100%" height="100%">
        <defs>
          <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" style={{ stopColor: '#F28D9C', stopOpacity: 1 }} /> 
            <stop offset="50%" style={{ stopColor: '#D9535A', stopOpacity: 1 }} /> 
            <stop offset="100%" style={{ stopColor: '#F24C61', stopOpacity: 1 }} /> 
          </linearGradient>
        </defs>
  
        {/* Animated Circles */}
        <circle cx="5" cy="5" r="0.7" fill="url(#grad1)">
        ...
        <circle cx="5" cy="5" r="0.6" fill="url(#grad1)">
        ...
        <circle cx="5" cy="5" r="0.5" fill="url(#grad1)">
